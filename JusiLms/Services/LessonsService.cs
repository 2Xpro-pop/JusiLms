...
public class LessonsService : ILessonsService
{
    ...
    public async Task<IEnumerable<Lesson>> GetAllLessons() => await _context.Lessons.ToArrayAsync();
    public async Task<Lesson?> GetLessonById(Guid id) => await _context.Lessons.FindAsync(id);
    public async Task<IEnumerable<Lesson>> GetLessonsByCategory(Guid categoryId) => await _context.Lessons.Where(l => l.CategoryId == categoryId).ToArrayAsync();
